...
- Active: `WO-0183` canonical route and compatibility alias policy
- Planned: `WO-0184` static tool surface shell alignment
- Planned: `WO-0185` latest spec surface strategy and shell implementation
- Planned: `WO-0186` fixture mirror source-of-truth consolidation
- Planned: `WO-0187` animation and diagram asset naming normalization
...
- The formal queue is open again under `docs/workorders/`, beginning with `WO-0183`.
