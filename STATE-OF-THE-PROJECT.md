...
- Active next lane: `WO-0189` v0.2 publication readiness and adopter verification
...
- The formal queue is open again under `docs/workorders/`, and the active next lane is now `WO-0189` after the completed `WO-0183` through `WO-0193` execution sequence.
