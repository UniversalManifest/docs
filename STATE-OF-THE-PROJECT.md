...
- The formal queue is open again under `docs/workorders/`, and the remaining active site-architecture lane is now `WO-0187` after the completed `WO-0183`, `WO-0184`, `WO-0185`, and `WO-0186` gates.
