...
2. **Author the evidence pack** at `docs/reports/2026-04-26-v0-2-publication-evidence-pack.md` using the template.
3. **Re-run the publication smoke** (`npm run smoke:publication` from WO-0227) and capture the output in the evidence pack.
...
- `docs/reports/2026-04-26-v0-2-publication-evidence-pack.md` (new)
...
- `docs/reports/2026-04-26-v0-2-publication-evidence-pack.md` exists, matches the template, and pins every gate to evidence.
