...
- WO-0220 (PREP COMPLETE 2026-04-26 — operator-gated tag/release pending): `docs/workorders/WO-0220-v0-2-release-tag-and-immutable-artifact-hash-pinning.md` — autonomous prep done: hashes verified MATCHED + reproducible (`schema.json: fe79ddb4...`, `schema.jsonld: 005bd972...`); changelog hashes subsection added; `RELEASING.md` tag convention pinned to `spec-vX.Y`. Operator must now run `git tag -a spec-v0.2 -m "..." && git push origin spec-v0.2 && gh release create spec-v0.2 --notes-file ...` (exact commands in `.dev/ai/subtask-comms/2026-04-26-wo-0220-result.md`).
