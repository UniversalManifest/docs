...
- WO-0258 (IN_PROGRESS 2026-05-02): `docs/workorders/WO-0258-ci-and-staging-gate-remediation-after-homepage-redesign.md` — repair the remaining CI/staging verification failures after the homepage redesign so `WO-0255` can resume
