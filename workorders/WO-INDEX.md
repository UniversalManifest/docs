...
- WO-0255 (BLOCKED): `docs/workorders/WO-0255-public-route-and-deployment-verification-v0-2-reader-path.md` — verify production reader routes after the approved redesign is implemented/deployed; blocked on WO-0257 so the pushed ref can build/deploy before route verification
